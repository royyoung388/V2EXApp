...
public class HotTopicsFragment extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener, FragmentView {
        ...
        recycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    Glide.with(HotTopicsFragment.this).resumeRequests();
                } else {
                    Log.i("HotFragment", "Recycler Scroll Resume");
                    Glide.with(HotTopicsFragment.this).pauseRequests();
                }
            }
    ...
    public void onFailed() {
        Log.i("----HotTopicsFragment", "on failed");
